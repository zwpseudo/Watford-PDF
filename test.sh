...
main() {
    ...
    run_tests "Watford-PDF-Ultra-Lite" "./exampleYmlFiles/docker-compose-latest-ultra-lite.yml"
    run_tests "Watford-PDF-Lite" "./exampleYmlFiles/docker-compose-latest-lite.yml"
    run_tests "Watford-PDF" "./exampleYmlFiles/docker-compose-latest.yml"
    ...
    run_tests "Watford-PDF-Ultra-Lite-Security" "./exampleYmlFiles/docker-compose-latest-ultra-lite-security.yml"
    run_tests "Watford-PDF-Lite-Security" "./exampleYmlFiles/docker-compose-latest-lite-security.yml"
    run_tests "Watford-PDF-Security" "./exampleYmlFiles/docker-compose-latest-security.yml"
